...
- [LWJGL - Lightweight Java Game Library](https://www.lwjgl.org/customize)
...
- JE - Java 版 (需安装 jdk, mac m1 新手建议直接 x86 转译)
  - HMCL (新手建议下载稳定版; m1 使用 arm jdk 指定 lwjgl 库路径即可)
